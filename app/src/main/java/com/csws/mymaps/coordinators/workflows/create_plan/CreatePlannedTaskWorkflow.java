package com.csws.mymaps.coordinators.workflows.create_plan;
...
public class CreatePlannedTaskWorkflow extends BaseWorkflow implements PlannedTaskConfigFragment.Listener, PlaceSearchFragment.PlaceSelectionListener {
    ...
    public CreatePlannedTaskWorkflow(CreatePlannedTaskViewModel viewModel, CoordinatorContext context) {
        super(context);
