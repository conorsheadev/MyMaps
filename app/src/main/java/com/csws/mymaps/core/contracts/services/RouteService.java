...
public interface RouteService {
    ...
    void estimateRoute(LatLng origin, LatLng destination, TravelTimeCallback callback);


    interface RouteCallback {
        void onRouteReady(NavigationRoute route);
        void onRouteError(Exception exception);
    }

    interface TravelTimeCallback {
        void onEstimateReady(NavigationEstimate estimate);
        void onEstimateError(Exception exception);
    }
}
