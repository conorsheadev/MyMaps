package com.csws.mymaps.activities.planner.weekly;
...
import com.csws.mymaps.activities.planner.models.PlannerDay;
...
public class WeeklyPlannerFragment extends Fragment {
    ...
    private List<PlannerDay> buildPlannerDays(List<PlannedTask> allPlannedTasks, List<TaskItem> allTasks) {
        ...
        for (LocalDate day : days) {
            ...
            for (PlannedTask plannedTask : allPlannedTasks) {
                ...
                LocalDate plannedDate = getPlannedTaskDate(plannedTask);

                if (day.equals(plannedDate)) {
            ...
            //PlannerDay
            PlannerDay plannerDay = new PlannerDay(day.toString(),resolvedTasks,plannedForDay);
    ...
    private LocalDate getPlannedTaskDate(PlannedTask plannedTask) {
